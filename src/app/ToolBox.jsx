...
export const ToolBox = () => {
  ...
  return (
    <div
      className={cx(
        'border-border absolute -top-px -left-[calc(0.5rem-1px)] flex h-[calc(100%+2px)] w-44 -translate-x-full flex-col gap-1 overflow-y-auto rounded-sm border bg-black p-2',
